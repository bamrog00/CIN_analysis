class Cytoband:
    def __init__(self, cyto_number, chromosome_number, start, end, length):
        self.cyto_number = cyto_number
        self.chromosome_number = chromosome_number
        self.chromosome_cyto = chromosome_number + '_' + cyto_number
        self.start = start
        self.end = end
        self.length = length
    ...
    def printAttributes(self):
        print('Cyto Number')
        print(self.cyto_number)
        print('Chr number')
        print(self.chromosome_number)
        print('Chromosome number and cytonumber combination')
        print(self.chromosome_cyto)
        print('Start')
        print(self.start)
        print('End')
        print(self.end)
